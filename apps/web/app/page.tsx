    ...
    <div className="min-h-screen bg-ink-50 font-body text-ink-900">
      ...
      <header className="sticky top-0 z-50 border-b border-ink-200/70 bg-ink-50/80 backdrop-blur-md">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <Link
              href="/sign-in"
              className="hidden rounded-lg px-3 py-2 text-sm font-medium text-ink-700 transition-colors hover:bg-ink-100 hover:text-ink-900 sm:inline-flex"
            >
              Iniciar sesión
            </Link>
            <a
      ...
      <section className="relative overflow-hidden">
        <div
          ...
          style={{
            background:
              "radial-gradient(60% 40% at 80% 0%, rgba(5,150,105,0.10), transparent 70%), radial-gradient(50% 35% at 10% 10%, rgba(15,15,20,0.04), transparent 70%)",
          }}
        />
          ...
          <div className="lg:col-span-7 lg:pt-6">
            ...
            <Reveal delay={220}>
              <div className="mt-10 flex flex-col items-start gap-3 sm:flex-row sm:items-center">
                ...
                <a
                  href="#mobile"
                  className="press inline-flex items-center gap-2 rounded-xl border border-ink-200 bg-white px-5 py-3.5 text-base font-medium text-ink-800 transition-colors hover:bg-ink-100"
                >
                  Ver cómo funciona
                </a>
              </div>
                ...
                <div className="col-span-12 sm:col-span-7">
                  <div className="relative h-full overflow-hidden rounded-3xl border border-ink-200 bg-gradient-to-br from-ink-50 to-white p-6 sm:p-8">
                    ...
                    <p className="mt-1 text-sm text-ink-600">
                      Hospital Ángeles · Enfermería · Módulo 3
                    </p>
      ...
      {/* Industries Bento */}
      <section id="industrias" className="bg-ink-50">
