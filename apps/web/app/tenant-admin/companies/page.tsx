...
import { Building2, Plus, Users, GraduationCap, Mail, Pencil } from "lucide-react";
              ...
              <div className="flex items-start gap-3">
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    <h3 className="truncate font-heading text-base font-semibold text-text-primary group-hover:text-primary-700">
                      {c.name}
                    </h3>
                    {c.contactEmail && (
                ...
                <div className="flex shrink-0 items-center">
                  <Link
                    href={`/tenant-admin/companies/${c.id}/edit`}
                  ...
                  <DeleteCompanyButton
                    ...
                    assignmentsCount={c._count.courseAssignments}
                    variant="icon"
                  />
                </div>
              </div>
